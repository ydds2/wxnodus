...
// V4 UI 重构：纯函数模型迁 lib/textInputModel.ts（导出面不变——re-export 保既有导入路径）
export {
  wordBoundsAt, lineBoundsAt, applyPrintableInsert, shouldRouteMultiCharInputAsPaste,
  shouldPreserveCtrlJNewline, lineNav, canFastAppendShape, canFastBackspaceShape,
  supportsFastEchoTerminal,
} from '../lib/textInputModel.js'
import {
  FWD_DEL_RE,
  PRINTABLE,
  BRACKET_PASTE,
  ...
  isPasteResultPromise, shouldPreserveCtrlJNewline, wordBoundsAt, lineBoundsAt,
  canFastAppendShape,
...
export function useFwdDelete(active: boolean) {
