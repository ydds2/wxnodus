...
// （forked_from_id）；§13.56 起 usage 成本五维升 10（reasoning_tokens）；HTTP serve 所有权升 11；
// P2-14（2026-08-27）durable_prompts 用户消息持久队列升 12。
...
describe('KF-030 resolved: schema version no longer drifts', () => {
  it('openDB 后将 schema_version 对齐到 12 并记录 migration history', () => {
