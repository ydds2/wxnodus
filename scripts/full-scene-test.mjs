...
// winpty/ConPTY 合成键盘环境实测陷阱（均已在脚本内规避；2026-08 复测：CJK 与 ASCII
// 在 5ms/字符双管线均零丢字——parse-keypress 批次读取修复已根治，200ms 慢速为 CI
// 确定性安全余量保留）：
...
//    （2026-08 已修：空闲 Ctrl+C 改无操作+提示，不再杀会话/停摆；脚本仍保守不盲发。）
