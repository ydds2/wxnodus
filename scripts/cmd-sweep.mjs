...
const groups = {
  ...
  '会话': ['/fork', '/init', '/checkpoint list', '/checkpoint', '/versions', '/snapshot', '/memory list', '/usage --waterfall', '/script list', '/script record sweep-tmp', '/script stop', '/script verify sweep-tmp', '/script ci', '/self-evolve 列出当前能力'],
  '钩子': ['/hooks'],
