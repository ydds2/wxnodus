...
| **加权总分（/1000）** | **814** | **869** | **812** | **841** | **709** | **693** | **573** |

**排名：codex 8.69 ＞ opencode 8.41 ＞ wxnodus 8.14 ＞ gemini 8.12 ＞ crush 7.09 ＞ kimi 6.93 ＞ aider 5.73。**（wxnodus 由 6.14→7.25→7.54→7.90→8.14：**反超 gemini 升至第 3/7**；④⑤ 补轮后距 opencode 841 差 27、距 codex 869 差 55）
